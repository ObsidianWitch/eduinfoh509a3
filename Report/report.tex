...
\bibitem{cite:xqilla} \emph{xqilla}, \href{http://xqilla.sourceforge.net/HomePage}{http://xqilla.sourceforge.net/HomePage}

\bibitem{cite:xpathtester} \emph{xpathtester}, \href{http://www.xpathtester.com/xquery}{http://www.xpathtester.com/xquery}

\bibitem{cite:sodfs} \emph{XQuery - BFS to find all paths between two nodes}
\href{https://stackoverflow.com/questions/24381341/xquery-bfs-to-find-all-paths-between-two-nodes}{https://stackoverflow.com/questions/24381341/xquery-bfs-to-find-all-paths-between-two-nodes}
\end{thebibliography}
